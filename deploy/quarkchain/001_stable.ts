...
const func: DeployFunction = async function (hre: HardhatRuntimeEnvironment) {
	...
	const usdc = await ethers.getContractAt('MockERC20', '0xE59c1Ddf4fAAC4Fa7C8c93d9392d4bBa55383268');
	const usdt = await ethers.getContractAt('MockERC20', '0x1a69a6e206c680A8559c59b951527437CBCe6Ed7');
	const dai = await ethers.getContractAt('MockERC20', '0x51b90a5Bc99B7c76EDf3863E1d61ca6197a6e542');
	const tusd = await ethers.getContractAt('MockERC20', '0xD71C821a373E16D607277DB6C1356c1209C7d866');
	...
	// const lpAddr =  await poolContract['getLpToken()']()
...
export default func;
func.tags = ['stable-quark-test-s0'];
