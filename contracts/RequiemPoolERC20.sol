...
import "./interfaces/IRequiemPoolERC20.sol";

// solhint-disable not-rely-on-time, no-inline-assembly, var-name-mixedcase, max-line-length

contract RequiemPoolERC20 is IRequiemPoolERC20 {

    string public constant name = "Requiem Weighted Pool Liquidity Provider";
    string public constant symbol = "RWPLP";
