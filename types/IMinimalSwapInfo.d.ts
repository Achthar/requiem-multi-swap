...
interface IMinimalSwapInfoInterface extends ethers.utils.Interface {
  functions: {
...
export class IMinimalSwapInfo extends BaseContract {
  ...
  interface: IMinimalSwapInfoInterface;
