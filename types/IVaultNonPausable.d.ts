...
interface IVaultNonPausableInterface extends ethers.utils.Interface {
  functions: {
...
export class IVaultNonPausable extends BaseContract {
  ...
  interface: IVaultNonPausableInterface;
