...
interface IRequiem2PoolFactoryInterface extends ethers.utils.Interface {
  functions: {
...
export class IRequiem2PoolFactory extends BaseContract {
  ...
  interface: IRequiem2PoolFactoryInterface;
