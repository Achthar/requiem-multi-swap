...
interface IVaultAuthorizerInterface extends ethers.utils.Interface {
  functions: {
...
export class IVaultAuthorizer extends BaseContract {
  ...
  interface: IVaultAuthorizerInterface;
