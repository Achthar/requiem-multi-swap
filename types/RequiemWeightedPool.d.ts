...
interface RequiemWeightedPoolInterface extends ethers.utils.Interface {
  functions: {
    ...
    "initialize(address[],uint32[],uint32)": FunctionFragment;
    ...
    "token4()": FunctionFragment;
    "token5()": FunctionFragment;
  ...
  encodeFunctionData(functionFragment: "token4", values?: undefined): string;
  encodeFunctionData(functionFragment: "token5", values?: undefined): string;
  encodeFunctionData(
  ...
  decodeFunctionResult(functionFragment: "token4", data: BytesLike): Result;
  decodeFunctionResult(functionFragment: "token5", data: BytesLike): Result;
  decodeFunctionResult(
    functionFragment: "totalSupply",
    data: BytesLike
  ): Result;
...
export class RequiemWeightedPool extends BaseContract {
  ...
  interface: RequiemWeightedPoolInterface;
  ...
  functions: {
    ...
    token4(overrides?: CallOverrides): Promise<[string]>;

    token5(overrides?: CallOverrides): Promise<[string]>;
  ...
  estimateGas: {
    ...
    token4(overrides?: CallOverrides): Promise<BigNumber>;

    token5(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    token4(overrides?: CallOverrides): Promise<PopulatedTransaction>;

    token5(overrides?: CallOverrides): Promise<PopulatedTransaction>;
