...
interface RequiemWeightedPoolFactoryInterface extends ethers.utils.Interface {
  functions: {
...
export class RequiemWeightedPoolFactory extends BaseContract {
  ...
  interface: RequiemWeightedPoolFactoryInterface;
