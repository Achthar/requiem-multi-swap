...
interface IRequiemWeightedPoolInterface extends ethers.utils.Interface {
  functions: {
...
export class IRequiemWeightedPool extends BaseContract {
  ...
  interface: IRequiemWeightedPoolInterface;
