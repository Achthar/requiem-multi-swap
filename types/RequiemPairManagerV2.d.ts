...
interface RequiemPairManagerV2Interface extends ethers.utils.Interface {
  functions: {
...
export class RequiemPairManagerV2 extends BaseContract {
  ...
  interface: RequiemPairManagerV2Interface;
