...
interface RequiemMultiRouterInterface extends ethers.utils.Interface {
  functions: {
...
export class RequiemMultiRouter extends BaseContract {
  ...
  interface: RequiemMultiRouterInterface;
