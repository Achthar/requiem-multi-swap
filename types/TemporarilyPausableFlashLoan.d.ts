...
interface TemporarilyPausableFlashLoanInterface extends ethers.utils.Interface {
  functions: {
...
export class TemporarilyPausableFlashLoan extends BaseContract {
  ...
  interface: TemporarilyPausableFlashLoanInterface;
