...
interface IRequiemParaRouterInterface extends ethers.utils.Interface {
  functions: {
...
export class IRequiemParaRouter extends BaseContract {
  ...
  interface: IRequiemParaRouterInterface;
