...
interface WeightedRouterV2Interface extends ethers.utils.Interface {
  functions: {
...
export class WeightedRouterV2 extends BaseContract {
  ...
  interface: WeightedRouterV2Interface;
