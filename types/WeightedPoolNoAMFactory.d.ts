...
interface WeightedPoolNoAMFactoryInterface extends ethers.utils.Interface {
  functions: {
...
export class WeightedPoolNoAMFactory extends BaseContract {
  ...
  interface: WeightedPoolNoAMFactoryInterface;
