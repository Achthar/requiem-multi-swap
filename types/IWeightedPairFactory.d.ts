...
interface IWeightedPairFactoryInterface extends ethers.utils.Interface {
  functions: {
...
export class IWeightedPairFactory extends BaseContract {
  ...
  interface: IWeightedPairFactoryInterface;
