...
interface RequiemQRouterBackupInterface extends ethers.utils.Interface {
  functions: {
    ...
    "onSwapETHForExactTokens(address,uint256,address[],address,uint256)": FunctionFragment;
    "onSwapExactETHForTokens(tuple[],uint256,address,uint256)": FunctionFragment;
    "onSwapExactTokensForETH(tuple[],uint256,uint256,address,uint256)": FunctionFragment;
...
export class RequiemQRouterBackup extends BaseContract {
  ...
  interface: RequiemQRouterBackupInterface;
