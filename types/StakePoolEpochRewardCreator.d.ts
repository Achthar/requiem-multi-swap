...
interface StakePoolEpochRewardCreatorInterface extends ethers.utils.Interface {
  functions: {
...
export class StakePoolEpochRewardCreator extends BaseContract {
  ...
  interface: StakePoolEpochRewardCreatorInterface;
