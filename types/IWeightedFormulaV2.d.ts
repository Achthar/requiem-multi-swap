...
interface IWeightedFormulaV2Interface extends ethers.utils.Interface {
  functions: {
...
export class IWeightedFormulaV2 extends BaseContract {
  ...
  interface: IWeightedFormulaV2Interface;
