...
interface IRequiemWeightedPoolFactoryInterface extends ethers.utils.Interface {
  functions: {
    "allPairs(uint256)": FunctionFragment;
    "allPairsLength()": FunctionFragment;
    "createPool(address[],uint32[],uint32)": FunctionFragment;
...
export class IRequiemWeightedPoolFactory extends BaseContract {
  ...
  interface: IRequiemWeightedPoolFactoryInterface;
