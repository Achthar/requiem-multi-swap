...
interface IWeightedPairManagerInterface extends ethers.utils.Interface {
  functions: {
...
export class IWeightedPairManager extends BaseContract {
  ...
  interface: IWeightedPairManagerInterface;
