...
interface ManagedPoolInterface extends ethers.utils.Interface {
  functions: {
    ...
    "withdrawCollectedManagementFees(address)": FunctionFragment;
  };
  ...
  encodeFunctionData(
    functionFragment: "getCollectedManagementFees",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "getManagementSwapFeePercentage",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "withdrawCollectedManagementFees",
    values: [string]
  ): string;
  ...
  events: {
    ...
    "ManagementFeePercentageChanged(uint256)": EventFragment;
    "ManagementFeesCollected(address[],uint256[])": EventFragment;
  ...
  getEvent(
    nameOrSignatureOrTopic: "ManagementFeePercentageChanged"
  ): EventFragment;
  getEvent(nameOrSignatureOrTopic: "ManagementFeesCollected"): EventFragment;
...
export type ManagementFeePercentageChangedEvent = TypedEvent<
  [BigNumber] & { managementFeePercentage: BigNumber }
>;

export type ManagementFeesCollectedEvent = TypedEvent<
...
export class ManagedPool extends BaseContract {
  ...
  interface: ManagedPoolInterface;
  ...
  functions: {
    ...
    getCollectedManagementFees(
      ...
      [string[], BigNumber[]] & { tokens: string[]; collectedFees: BigNumber[] }
    >;
  ...
  getManagementSwapFeePercentage(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  filters: {
    ...
    "ManagementFeePercentageChanged(uint256)"(
      managementFeePercentage?: null
    ): TypedEventFilter<[BigNumber], { managementFeePercentage: BigNumber }>;

    ManagementFeePercentageChanged(
      managementFeePercentage?: null
    ): TypedEventFilter<[BigNumber], { managementFeePercentage: BigNumber }>;

    "ManagementFeesCollected(address[],uint256[])"(
      tokens?: null,
      amounts?: null
    ): TypedEventFilter<
      [string[], BigNumber[]],
      { tokens: string[]; amounts: BigNumber[] }
    >;
  ...
  estimateGas: {
    ...
    getCollectedManagementFees(overrides?: CallOverrides): Promise<BigNumber>;
