...
interface IOriginUniswapV2FactoryInterface extends ethers.utils.Interface {
  functions: {
...
export class IOriginUniswapV2Factory extends BaseContract {
  ...
  interface: IOriginUniswapV2FactoryInterface;
