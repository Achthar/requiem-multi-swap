...
interface TwoTokenPoolsBalanceInterface extends ethers.utils.Interface {
  functions: {
...
export class TwoTokenPoolsBalance extends BaseContract {
  ...
  interface: TwoTokenPoolsBalanceInterface;
