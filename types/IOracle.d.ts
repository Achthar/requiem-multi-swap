...
interface IOracleInterface extends ethers.utils.Interface {
  functions: {
    ...
    "consultDollarPrice(address,uint256)": FunctionFragment;
    "epoch()": FunctionFragment;
    "nextEpochPoint()": FunctionFragment;
    "twap(uint256)": FunctionFragment;
    "twapDollarPrice(address,uint256)": FunctionFragment;
    "update()": FunctionFragment;
    "updateCumulative()": FunctionFragment;
  };
  ...
  encodeFunctionData(
    functionFragment: "consultDollarPrice",
    values: [string, BigNumberish]
  ): string;
  ...
  encodeFunctionData(functionFragment: "twap", values: [BigNumberish]): string;
  encodeFunctionData(
    functionFragment: "twapDollarPrice",
    values: [string, BigNumberish]
  ): string;
  encodeFunctionData(functionFragment: "update", values?: undefined): string;
  encodeFunctionData(
    functionFragment: "updateCumulative",
    values?: undefined
  ): string;
...
export class IOracle extends BaseContract {
  ...
  functions: {
    ...
    consultDollarPrice(
      ...
      _amountIn: BigNumberish,
      overrides?: CallOverrides
    ): Promise<[BigNumber] & { _dollarPrice: BigNumber }>;
  ...
  twap(_amountIn: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
  ...
  callStatic: {
    ...
    updateCumulative(overrides?: CallOverrides): Promise<void>;
  };
