...
interface IFormulaProviderInterface extends ethers.utils.Interface {
  functions: {
...
export class IFormulaProvider extends BaseContract {
  ...
  interface: IFormulaProviderInterface;
