...
interface ITemporarilyPausableVaultInterface extends ethers.utils.Interface {
  functions: {
...
export class ITemporarilyPausableVault extends BaseContract {
  ...
  interface: ITemporarilyPausableVaultInterface;
