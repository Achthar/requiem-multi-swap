...
interface IRequiemMultiRouterInterface extends ethers.utils.Interface {
  functions: {
...
export class IRequiemMultiRouter extends BaseContract {
  ...
  interface: IRequiemMultiRouterInterface;
