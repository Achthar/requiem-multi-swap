...
interface RequiemPoolFormulaInterface extends ethers.utils.Interface {
  functions: {
...
export class RequiemPoolFormula extends BaseContract {
  ...
  interface: RequiemPoolFormulaInterface;
