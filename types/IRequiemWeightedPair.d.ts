...
interface IRequiemWeightedPairInterface extends ethers.utils.Interface {
  functions: {
...
export class IRequiemWeightedPair extends BaseContract {
  ...
  interface: IRequiemWeightedPairInterface;
