...
interface RequiemParaRouterInterface extends ethers.utils.Interface {
  functions: {
...
export class RequiemParaRouter extends BaseContract {
  ...
  interface: RequiemParaRouterInterface;
