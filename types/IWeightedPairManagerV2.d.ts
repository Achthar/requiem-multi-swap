...
interface IWeightedPairManagerV2Interface extends ethers.utils.Interface {
  functions: {
...
export class IWeightedPairManagerV2 extends BaseContract {
  ...
  interface: IWeightedPairManagerV2Interface;
