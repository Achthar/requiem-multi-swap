...
interface StakePoolInterface extends ethers.utils.Interface {
  functions: {
    ...
    "getRewardPerSecond(uint8,uint256,uint256)": FunctionFragment;
...
export class StakePool extends BaseContract {
  ...
  functions: {
    ...
    "getRewardPerSecond(uint8,uint256,uint256)"(
      pid: BigNumberish,
      from: BigNumberish,
      to: BigNumberish,
      overrides?: CallOverrides
    ...
    rewardPoolInfo(
      ...
      [
        ...
        rewardToken: string;
        rewardRebaser: string;
        rewardMultiplier: string;
        startRewardTime: BigNumber;
        lastRewardTime: BigNumber;
        endRewardTime: BigNumber;
        rewardPerSecond: BigNumber;
        accRewardPerShare: BigNumber;
        lockRewardPercent: BigNumber;
        startVestingTime: BigNumber;
        endVestingTime: BigNumber;
    ...
    userInfo(
      ...
      [BigNumber, BigNumber] & { amount: BigNumber; lastStakeTime: BigNumber }
    >;
