...
interface RequiemMockInterface extends ethers.utils.Interface {
  functions: {
    "isPair(address)": FunctionFragment;
    "setIsPair(address,bool)": FunctionFragment;
  };

  encodeFunctionData(functionFragment: "isPair", values: [string]): string;
  encodeFunctionData(
    functionFragment: "setIsPair",
    values: [string, boolean]
  ): string;

  decodeFunctionResult(functionFragment: "isPair", data: BytesLike): Result;
  decodeFunctionResult(functionFragment: "setIsPair", data: BytesLike): Result;

  events: {};
}

export class RequiemMock extends BaseContract {
  ...
  interface: RequiemMockInterface;
