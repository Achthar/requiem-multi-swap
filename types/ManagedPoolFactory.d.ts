...
interface ManagedPoolFactoryInterface extends ethers.utils.Interface {
  functions: {
    "create(string,string,address[],uint256[],uint256,address,bool,uint256)": FunctionFragment;
...
export class ManagedPoolFactory extends BaseContract {
  ...
  interface: ManagedPoolFactoryInterface;
