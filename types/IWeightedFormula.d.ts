...
interface IWeightedFormulaInterface extends ethers.utils.Interface {
  functions: {
...
export class IWeightedFormula extends BaseContract {
  ...
  interface: IWeightedFormulaInterface;
