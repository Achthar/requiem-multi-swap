...
interface IOriginUniswapV2PairInterface extends ethers.utils.Interface {
  functions: {
...
export class IOriginUniswapV2Pair extends BaseContract {
  ...
  interface: IOriginUniswapV2PairInterface;
