...
interface TemporarilyPausableVaultInterface extends ethers.utils.Interface {
  functions: {
...
export class TemporarilyPausableVault extends BaseContract {
  ...
  interface: TemporarilyPausableVaultInterface;
