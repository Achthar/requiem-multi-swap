...
interface RequiemWeightedPairFactoryV2Interface extends ethers.utils.Interface {
  functions: {
...
export class RequiemWeightedPairFactoryV2 extends BaseContract {
  ...
  interface: RequiemWeightedPairFactoryV2Interface;
