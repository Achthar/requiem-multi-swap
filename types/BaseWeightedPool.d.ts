...
interface BaseWeightedPoolInterface extends ethers.utils.Interface {
  functions: {
...
export class BaseWeightedPool extends BaseContract {
  ...
  interface: BaseWeightedPoolInterface;
