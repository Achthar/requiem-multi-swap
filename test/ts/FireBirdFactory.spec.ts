...
import {TestErc20, TestErc20Factory, RequiemPairFactory} from "../../typechain";
...
describe('FireBirdFactory', () => {
	...
	beforeEach(async () => {
		...
		uniswapPairBytecode = new RequiemPairFactory(wallet).bytecode;
	...
	async function createPair(tokens: [string, string], tokenWeightA: number,
		...
		const pair = RequiemPairFactory.connect(create2Address, wallet)
