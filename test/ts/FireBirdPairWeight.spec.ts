...
import {FireBirdFormula, RequiemERC20, FireBirdFactory, RequiemPair} from "../../typechain";
const overrides = {};
...
describe("RequiemPairWeight", () => {
  ...
  let token0: RequiemERC20;
  let tokenA: RequiemERC20;
  let formula: FireBirdFormula;
  let tokenWeight0: number;
  let token1: RequiemERC20;
  let tokenB: RequiemERC20;
  ...
  it('swap:gas', async () => {
    ...
    expect(receipt.gasUsed).to.eq(86129)
  })
